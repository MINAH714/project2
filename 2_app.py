...
The final output must be strictly in the following JSON format:
{
  "emotion": "sadness",
  "persona": "teenage girl",
  "dialogues": [
    {
      "user": "I fought with my friend at school today.",
      "chatbot": "That must have been tough. Thank you for sharing."
    },
    ...
  ]
}
